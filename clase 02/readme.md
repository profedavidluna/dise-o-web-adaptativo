¡Por supuesto! Aquí tienes el enunciado listo para copiar y pegar directamente en un archivo README.md de GitHub o cualquier otro repositorio, usando la sintaxis de Markdown para un formato limpio y profesional.
